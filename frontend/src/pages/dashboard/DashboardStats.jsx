                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-2 xl:grid-cols-4 lg:gap-4">
                    <div class="h-40 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex justify-start items-center">
                        <div className="stat_data pl-4">
                            ...
                            <h2 className='text-gray-900 dark:text-gray-100 mt-1.5 text-2xl font-semibold'>232,789</h2>
                            <p className='text-gray-900 mt-1.5 bg-gray-200 px-3 py-1 w-16 rounded-lg'>+1.5k</p>
                        </div>
                    </div>
                    ...
                    <div className="rounded-lg md:col-span-1 lg:col-span-4 xl:col-span-3">
                        ...
                        <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-4 rounded-lg">
                            ...
                            <div className="lg:col-span-1">
                                <div class="h-28 mb-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex justify-start items-center">
                                    <div className="stat_data pl-4">
                                        <h3 className='text-gray-900 dark:text-gray-100 mt-1.5 text-lg font-medium'>Total Bags</h3>
                                        <h3 className='mt-2 text-gray-900 dark:text-gray-100'>
                                            <span className='text-xl font-semibold mr-2'>298,823</span>
                                            <span className='bg-gray-200 text-gray-900 rounded-xl text-sm p-1.5'>+1.5k</span>
                                        </h3>
                                    </div>
                                </div>
                                <div class="h-28 mb-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex justify-start items-center">
